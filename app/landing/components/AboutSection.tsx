  ...
  return (
    <section ref={aboutRef} id="about" className="relative z-10 mx-auto max-w-6xl px-6 pb-28 scroll-mt-20 mt-16">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        {/* About the shop */}
        <div className="animate-fade-up rounded-2xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900/50">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed mb-4">
            Với hơn <strong className="text-slate-900 dark:text-white">1.000 sản phẩm</strong> trải dài từ thời trang, phụ kiện đến đồ gia dụng cute, Lion Shop luôn cập nhật xu hướng mới nhất để bạn luôn trendy với mức giá siêu hạt dẻ — bắt đầu chỉ từ <strong className="text-slate-900 dark:text-white">29.000₫</strong>.
          </p>
        ...
        {/* About the owner */}
        <div className="animate-fade-up rounded-2xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900/50" style={{ animationDelay: '0.15s' }}>
          <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-slate-900 text-white dark:bg-white dark:text-slate-900 shadow-sm text-2xl">
            👩
          </div>
          ...
          <div className="flex items-start gap-4 mb-5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400">📍 Quảng Trị</p>
